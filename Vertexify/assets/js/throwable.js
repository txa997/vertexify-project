! function($) {
    ...
    class i {
        constructor(i, s) {
            this._defaults = e, this._name = t, this.options = {
                ...e,
                ...s
            }, this.DOM = {}, this.DOM.element = i, this.DOM.$element = $(i), this.DOM.throwables = this.DOM.element.querySelectorAll("[data-txr-throwable-item]"), this.onWindowResize = tpDebounce(this.onWindowResize.bind(this), 250), this.bodies = [], this.init()
        }
        init() {
    ...
    $("[data-txr-throwable-area]").tpThrowable()
}));